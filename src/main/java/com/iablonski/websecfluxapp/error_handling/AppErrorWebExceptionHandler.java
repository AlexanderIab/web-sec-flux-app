package com.iablonski.websecfluxapp.error_handling;
...
public class AppErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    public AppErrorWebExceptionHandler(AppErrorAttributes attributes, ApplicationContext applicationContext,
